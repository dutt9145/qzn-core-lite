...
using InitializePortal_input     = QZNNODES::InitializePortal_input;
using InitializePortal_output    = QZNNODES::InitializePortal_output;
using IssueNode_input            = QZNNODES::IssueNode_input;
using IssueNode_output           = QZNNODES::IssueNode_output;
using TransferNode_input         = QZNNODES::TransferNode_input;
using TransferNode_output        = QZNNODES::TransferNode_output;
using ClaimNodeRevenue_input     = QZNNODES::ClaimNodeRevenue_input;
using ClaimNodeRevenue_output    = QZNNODES::ClaimNodeRevenue_output;
using RegisterGame_input         = QZNNODES::RegisterGame_input;
using RegisterGame_output        = QZNNODES::RegisterGame_output;
using ApproveGame_input          = QZNNODES::ApproveGame_input;
using ApproveGame_output         = QZNNODES::ApproveGame_output;
using UpdateGameState_input      = QZNNODES::UpdateGameState_input;
using UpdateGameState_output     = QZNNODES::UpdateGameState_output;
using StakeForAccess_input       = QZNNODES::StakeForAccess_input;
using StakeForAccess_output      = QZNNODES::StakeForAccess_output;
using ReceiveProtocolFees_input  = QZNNODES::ReceiveProtocolFees_input;
using ReceiveProtocolFees_output = QZNNODES::ReceiveProtocolFees_output;
using GetPlayerAccess_input      = QZNNODES::GetPlayerAccess_input;
using GetPlayerAccess_output     = QZNNODES::GetPlayerAccess_output;
using GetNode_input              = QZNNODES::GetNode_input;
using GetNode_output             = QZNNODES::GetNode_output;
using GetGame_input              = QZNNODES::GetGame_input;
using GetGame_output             = QZNNODES::GetGame_output;
...
using GetPortalStats_input  = QZNNODES::GetPortalStats_input;
using GetPortalStats_output = QZNNODES::GetPortalStats_output;
...
template<> struct FuncOutput<QZNNODES::GetPortalStats_input> { using type = QZNNODES::GetPortalStats_output; };
...
template<> struct ContractIndexOf<QZNNODES> { static constexpr unsigned int value = 30; };
