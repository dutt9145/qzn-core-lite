...
constexpr sint64 QZN_ROUTE_PRIZE_BPS         = 3000LL;
constexpr sint64 QZN_ROUTE_STAKER_BPS        = 3000LL;
constexpr sint64 QZN_ROUTE_BUILDER_BPS       = 700LL;
constexpr sint64 QZN_ROUTE_LIQUIDITY_BPS     = 800LL;
constexpr sint64 QZN_ROUTE_BURN_BPS          = 700LL;
constexpr sint64 QZN_ROUTE_NODE_BPS          = 600LL;
constexpr sint64 QZN_ROUTE_TREASURY_BPS      = 500LL;
constexpr sint64 QZN_ROUTE_PORTAL_PROTO_BPS  = 200LL;
constexpr sint64 QZN_ROUTE_QSWAP_PROTO_BPS   = 200LL;
constexpr sint64 QZN_ROUTE_PROTOCOL_BPS      = 300LL;
