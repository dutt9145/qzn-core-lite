...
RUN sed -i 's/NUMBER_OF_CONTRACT_EXECUTION_BUFFERS 10/NUMBER_OF_CONTRACT_EXECUTION_BUFFERS 32/' /app/src/public_settings.h
...
RUN chmod +x /qzn/setup.sh && /qzn/setup.sh && cp /qzn/test/contract_globals.cpp /app/test/ && cp /qzn/test/concurrency_impl.cpp /app/test/ && cp /qzn/test/exec_globals.cpp /app/test/ && cp /qzn/test/platform.cpp /app/test/
